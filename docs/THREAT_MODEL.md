...
| Compromised vendor response | DELETE success is not trusted alone; an authoritative GET must return 404 before consumption. | Rust contract and independent operator verification | A compromised GitHub API returning a false 404 |
